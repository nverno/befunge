...
;; there is a mode for Befunge source, interpreter-mode for the
;; interpreter and interaction-mode for the output buffer. This is
;; "Interactive" in that keyboard input is echoed to befunge-output.
;; Lastly there is a mode of its own for the befunge-stack display
;; buffer.
